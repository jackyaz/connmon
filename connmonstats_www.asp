...
<td>
<input autocomplete="off" autocapitalize="off" type="text" maxlength="2" class="input_3_table removespacing" name="connmon_pingduration" value="60" onkeypress="return validator.isNumber(this, event)" onblur="Validate_PingDuration(this)" />
...
<td>Every
<input autocomplete="off" autocapitalize="off" type="text" maxlength="2" class="input_3_table removespacing" name="connmon_pingfrequency" value="3" onkeypress="return validator.isNumber(this, event)" onblur="Validate_PingFrequency(this)" />
