...
<td>
<a href="/ext/connmon/csv/CompleteResults.htm" download="connmon.csv"><input type="button" value="Export to CSV" class="button_gen" name="btnExport"></a>
</td>
</tr>
</table>
