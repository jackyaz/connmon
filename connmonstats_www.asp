...
<input autocomplete="off" autocapitalize="off" type="radio" name="connmon_dataoutput" id="connmon_dataoutput_average" class="input" value="average" checked>Average
<input autocomplete="off" autocapitalize="off" type="radio" name="connmon_dataoutput" id="connmon_dataoutput_raw" class="input" value="raw">Raw
</td>
</tr>
<tr class="even" id="rowtimeoutput">
<th width="40%">Time Output Mode</th>
<td class="settingvalue">
<input autocomplete="off" autocapitalize="off" type="radio" name="connmon_timeoutput" id="connmon_timeoutput_non-unix" class="input" value="non-unix" checked>Non-Unix
<input autocomplete="off" autocapitalize="off" type="radio" name="connmon_timeoutput" id="connmon_timeoutput_unix" class="input" value="unix">Unix
</td>
</tr>
<tr class="even" id="rowstorageloc">
<th width="40%">Data Storage Location</th>
<td class="settingvalue">
<input autocomplete="off" autocapitalize="off" type="radio" name="connmon_storageloc" id="connmon_storageloc_jffs" class="input" value="jffs" checked>JFFS
<input autocomplete="off" autocapitalize="off" type="radio" name="connmon_storageloc" id="connmon_storageloc_usb" class="input" value="usb">USB
</td>
</tr>
